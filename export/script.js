(function () {
  ...
  var CONTENT = {
    ...
    th: {
      ...
      timeline: { eyebrow_label: "การมาถึง", title: "เวลามาถึง", venue_note: "เมื่อมาถึง กรุณาขึ้นไปที่ชั้น 3 ก่อน จุดต้อนรับแขกจะอยู่ที่ชั้น 3 ส่วนกิจกรรมอื่น ๆ ของงานจะจัดทั้งชั้น 2 และชั้น 3", family_only: "พิธีส่วนตัวของครอบครัว", engagement: "พิธีสู่ขอแบบจีน", tea: "พิธีรดน้ำชา", welcome: "ต้อนรับแขก", welcome_sub: "เริ่มงานเลี้ยงต้อนรับ", note: "เราจะพร้อมต้อนรับทุกคนตั้งแต่ 11:30 น. เป็นต้นไป มื้อกลางวัน บทสนทนา และการเฉลิมฉลองจะค่อยๆ เกิดขึ้นเองตามธรรมชาติ" },
